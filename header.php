		...
		<div class="wrapper">
			...
			<div class="sidebar">
				...
				<div class="blog-header">
					...
					<h1 class="blog-title">
						<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home"><img class="logo-image" src="<?php echo get_template_directory_uri(); ?>/images/practical-meteor-logo.png"/></a>
					</h1>
